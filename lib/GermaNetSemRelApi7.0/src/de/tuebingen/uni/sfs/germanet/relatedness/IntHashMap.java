...
/**
 * Same as java.util.HashMap<String, Integer>, but allows for a check for
 ...
 */
public class IntHashMap extends HashMap<String, Integer> {
     ...
     *         mapping for key.
     */
    public Integer putCumulative(String key, Integer value) {
